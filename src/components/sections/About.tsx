...
export default async function About() {
  ...
  return (
    <section
      id="about"
      className="bg-surface-light dark:bg-surface-dark py-28 md:py-32"
    >
          ...
          <div>
            ...
            <FadeIn delay={0.1}>
              <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-4">
                A developer who enjoys building things from scratch and
                understanding the data behind them. Currently focused on
                React.js & Next.js.
              </p>
            </FadeIn>
            <FadeIn delay={0.15}>
              <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed">
                On the side, I explore datasets and ML just because I find it
                genuinely interesting. I value clean code, good documentation,
          ...
          <FadeIn delay={0.2}>
            <div className="bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-4">
                <svg
                  viewBox="0 0 24 24"
                  className="w-4 h-4 text-text-muted-light dark:text-text-muted-dark"
                  fill="currentColor"
                >
